...
public class CustomerServiceAgentConfiguration {
    ...
    // 手动构造器，只注入配置属性类
    public CustomerServiceAgentConfiguration(ChatModelApiKeyConfig chatModelApiKeyConfig) {
    ...
    public ReactAgent customerServiceAgent(
            ChatModel chatModel,
            CustomerServiceMemoryTools customerServiceMemoryTools,
            OrderQueryTools orderQueryTools,
            RoutePolicyTools routePolicyTools,
            TicketQueryTools ticketQueryTools,
